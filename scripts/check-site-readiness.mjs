...
const checks = [
  ...
  { path: "/blog/ai-prompt-card-generator-three-prompt-test", needle: "Three Topics Through the AI Prompt Card Generator" },
  { path: "/blog/evo-colony-system-design-teardown", needle: "Difference Between Activity and a System" },
  { path: "/blog/twelve-minute-review-method-for-web-works", needle: "The 12-Minute Review" },
  { path: "/blog/designing-failure-states-for-ai-tools", needle: "The Output Is Empty" },
  { path: "/blog/maintenance-ledger-for-public-web-works", needle: "A Maintenance Ledger" },
  { path: "/blog/how-to-remove-ai-sounding-copy", needle: "The Sentence Sounded Fine" },
  ...
  { path: "/blog/topics/product-craft", needle: "Product craft" },
  { path: "/blog/topics/publishing-operations", needle: "Publishing and operations" },
  { path: "/blog/topics/visual-experiments", needle: "Visual experiments" },
